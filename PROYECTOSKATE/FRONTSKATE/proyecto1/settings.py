...
SECRET_KEY = 'django-insecure-7-d9w4eh%3l_dp!pkr1i!f@^@))$rszsz$kstgig)57h2%t0hu'
...
LOGIN_REDIRECT_URL = "http://127.0.0.1:8000/administrador"
...
print("BASE_Join=>",os.path.join(BASE_DIR, 'proyecto1/static'))
